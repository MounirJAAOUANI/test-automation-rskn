  ...
  switch (agentId) {
    case "market-scout":
      return {
        ...
        data: {
          ...
          recommendation:
            "Niche viable — focus différenciation UI/UX minimaliste",
        },
      };
    ...
    case "logo-gen":
      return {
        ...
        data: {
          logoUrl:
            "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1024 1024'%3E%3Crect fill='%236C63FF' width='1024' height='1024' rx='256'/%3E%3Ctext x='512' y='600' font-size='300' fill='white' text-anchor='middle' font-family='Arial, sans-serif' font-weight='bold'%3EHF%3C/text%3E%3C/svg%3E",
          formats: {
    ...
    case "aso":
      return {
        ...
        data: {
          ...
          description:
            "HabitFlow est l'app minimaliste pour tracker une seule habitude chaque jour. Pas de distraction, pas de features inutiles — juste vous et votre habit. Streak counter, notifications quotidiennes, statistiques simples. Interface ultra-clean, design minimaliste. Gratuit avec option premium. [4000 chars optimisé SEO]",
          keywords:
            "habit tracker,daily routine,streak counter,habit builder,minimal tracker,habit app,productivity",
    ...
    case "compliance":
      return {
        ...
        data: {
          ...
          dataSafety: {
            dataTypes: [
              "App activity (AdMob impressions)",
    ...
    case "build-deploy":
      return {
        ...
        data: {
          ...
          draftUrl:
            "https://play.google.com/console/u/0/developers/.../habitflow/draft",
        },
      };
    ...
    >
      ...
      >
        ...
        >
          ...
          {status === "running" && <div style={{ fontSize: 20 }}>⏳</div>}
          {status === "success" && <div style={{ fontSize: 20 }}>✅</div>}
          <i
    ...
    >
      ...
      >
        <div style={{ fontSize: 18, fontWeight: 700, marginBottom: 8 }}>
          Track C — App Reskin Pipeline
        </div>
        <div style={{ fontSize: 13, color: "#666", marginBottom: 12 }}>
          Idée → App publiée Play Console (Brouillon) en{" "}
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              fontSize: 12,
              fontWeight: 500,
              background: mode === "full" ? "#1D9E75" : "#7F77DD",
              color: "#fff",
              border: "none",
              cursor: "pointer",
            }}
        ...
        <div style={{ marginBottom: "2rem" }}>
          <button
            ...
            style={{
              ...
              transition: "all 0.3s",
              boxShadow:
                !isRunning && !isFinalStepComplete
                  ? "0 4px 12px rgba(243, 156, 18, 0.3)"
                  : "none",
            }}
          >
            {isRunning
              ? `⏳ Pipeline en cours... (${currentStep}/${AGENTS.length})`
              : isFinalStepComplete
                ? "✅ Pipeline Complété!"
          ...
          >
            Durée totale estimée: {Math.floor(totalTime / 60)} min{" "}
            {totalTime % 60} sec
          </div>
        </div>
      )}
      ...
      <div style={{ marginBottom: "2rem" }}>
        ...
        >
          <span>
            Progression: {currentStep}/{AGENTS.length} agents
          </span>
        ...
        {AGENTS.map((agent, index) => (
          <div key={agent.id}>
            <AgentCard
              ...
              onExecute={
                mode === "step" &&
                (index === 0 || agentStates[AGENTS[index - 1].id] === "success")
                  ? () => handleStepExecution(index)
                  : null
              }
            ...
            {index < AGENTS.length - 1 && (
              <div
                style={{
                  ...
                  textAlign: "center",
                  color:
                    agentStates[agent.id] === "success" ? "#27AE60" : "#CCC",
                  fontSize: 12,
                  fontWeight: 500,
                }}
              >
      ...
      {isFinalStepComplete && (
        <div
          style={{
            ...
            padding: "16px 14px",
            borderRadius: 12,
            background: "linear-gradient(135deg, #E8F8F5, #E8EDFE)",
        ...
        >
          ...
          <div style={{ fontSize: 12, color: "#333", lineHeight: 1.8 }}>
            ...
            <br />
            📦 APK/AAB signé: habitflow.aab (45.2 MB)
            <br />
            🎨 Logo: 4 formats (1024×1024, 512×512, 192×192, 48×48)
            <br />
            📸 Screenshots: 5 images (1080×1920) avec device frame
            <br />
            📝 Privacy Policy: Hébergé GitHub Pages
            <br />
            📋 Data Safety: Déclaration JSON + UMP intégré
            <br />
            🎯 Listing: Titre, description SEO, 13 keywords
            <br />
            🔥 Firebase Remote Config: AdMob IDs configurables
            <br />
            <br />
            <strong>Prochaine étape:</strong>
            <br />
            1. Ouvrir Play Console
            <br />
            2. Vérifier le brouillon (screenshots, textes, icon)
            <br />
            3. Cliquer "Publier" (review Google Play: 2-7 jours)
            <br />
      ...
      >
        <div style={{ fontSize: 12, color: "#333", lineHeight: 1.6 }}>
          ⚠️ <strong>Coûts API utilisés (simulation):</strong> Claude Haiku
          ($0.052) + GPT Image 2 ($0.042) = <strong>$0.094/app</strong>
          <br />
          Après validation: Basculer SerpAPI Starter ($25/mois) pour market
          research automatisée.
          <br />
