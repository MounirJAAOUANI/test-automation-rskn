# Graph Report - test-automation-rskn  (2026-06-13)

## Corpus Check
- 30 files · ~68,280 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 312 nodes · 349 edges · 22 communities (18 shown, 4 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `68bc3cb3`
...
4. `buildPayload()` - 9 edges
5. `🔍 Dépannage {#dépannage}` - 8 edges
6. `compilerOptions` - 7 edges
7. `Variables du serveur (`server/.env`)` - 7 edges
8. `ask()` - 6 edges
9. `askJSON()` - 6 edges
10. `fetch` - 6 edges
...
- `buildPayload()` --calls--> `buildAppArchitectPayload()`  [EXTRACTED]
  client/src/App.jsx → client/src/steps/index.js
- `buildPayload()` --calls--> `buildASOPayload()`  [EXTRACTED]
  client/src/App.jsx → client/src/steps/index.js
- `buildPayload()` --calls--> `buildBuildDeployPayload()`  [EXTRACTED]
  client/src/App.jsx → client/src/steps/index.js
- `buildPayload()` --calls--> `buildCodeGenPayload()`  [EXTRACTED]
  client/src/App.jsx → client/src/steps/index.js
...
Cohesion: 0.09
Nodes (24): activePollers, githubLib, startGitHubPoller(), createJob(), fs, getAllJobKeys(), getAllJobs(), getJob() (+16 more)
...
Cohesion: 0.15
Nodes (14): PREREQS, runAgent(), runBuildAgent(), buildPayload(), ENV, STEPS, buildAppArchitectPayload(), buildASOPayload() (+6 more)
...
- **Why does `devDependencies` connect `Community 9` to `Community 0`?**
