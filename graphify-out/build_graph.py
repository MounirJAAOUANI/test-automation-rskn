...
to_json(G, communities, root / 'graphify-out' / 'graph.json')
analysis = {
...
(root / 'graphify-out' / '.graphify_analysis.json').write_text(json.dumps(analysis, indent=2, ensure_ascii=False), encoding='utf-8')
if G.number_of_nodes() == 0:
    raise RuntimeError('Graph is empty - extraction produced no nodes.')
